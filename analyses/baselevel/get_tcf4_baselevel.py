...
gene_baselevel.export("gs://gnomad-public/papers/2019-tx-annotation/results/SCN2A.baselevel.ext.021520.tsv.bgz")

gene_baselevel_prop= get_baselevel_expression_for_genes(mt, gtex, gene_list = {'SCN2A'}, get_proportions=True)
gene_baselevel_prop.export("gs://gnomad-public/papers/2019-tx-annotation/results/SCN2A.baselevel.pext.021520.tsv.bgz")
'''
